import { Alt, Alt1, Alt2, Alt2C } from '../src/Alt'
import { Apply, Apply1, Apply2, Apply2C } from '../src/Apply'
import { Chain, Chain1, Chain2, Chain2C } from '../src/Chain'
import { Separated, Compactable, Compactable1, Compactable2, Compactable2C } from '../src/Compactable'
import { Either } from '../src/Either'
import { Filterable, Filterable1, Filterable2, Filterable2C } from '../src/Filterable'
import { Foldable, Foldable1, Foldable2, Foldable2C } from '../src/Foldable'
import { Predicate, identity } from '../src/function'
import { Functor, Functor1, Functor2, Functor2C } from '../src/Functor'
import { HKT, Type, Type2, URIS, URIS2, HKT2 } from '../src/HKT'
import { Monoid } from '../src/Monoid'
import { Option } from '../src/Option'
import { Magma } from '../src/Magma'
import { Eq } from '../src/Eq'
import { Bifunctor, Bifunctor2 } from '../src/Bifunctor'
import { Ord } from '../src/Ord'
import { Ordering } from '../src/Ordering'
import { Profunctor, Profunctor2 } from '../src/Profunctor'
import { Show } from '../src/Show'
import { FunctorWithIndex, FunctorWithIndex1, FunctorWithIndex2, FunctorWithIndex2C } from '../src/FunctorWithIndex'
import {
  FoldableWithIndex,
  FoldableWithIndex1,
  FoldableWithIndex2,
  FoldableWithIndex2C
} from '../src/FoldableWithIndex'
import {
  FilterableWithIndex,
  FilterableWithIndex1,
  FilterableWithIndex2,
  FilterableWithIndex2C
} from '../src/FilterableWithIndex'
import { Extend, Extend2, Extend1, Extend2C } from '../src/Extend'
...
class FluentHKT<F, I, A> {
  ...
  equals<I extends Eq<HKT<F, A>>>(this: FluentHKT<F, I, A>, that: HKT<F, A>): boolean {
  ...
  reduce<I extends Foldable<F>, B>(this: FluentHKT<F, I, A>, b: B, f: (b: B, a: A) => B): B {
    return this.I.reduce(this.value, b, f)
  }
  foldMap<I extends Foldable<F>, M>(this: FluentHKT<F, I, A>, M: Monoid<M>): (f: (a: A) => M) => M {
    const foldMapM = this.I.foldMap(M)
    return f => foldMapM(this.value, f)
  }
  reduceRight<I extends Foldable<F>, B>(this: FluentHKT<F, I, A>, b: B, f: (a: A, b: B) => B): B {
  ...
  alt<I extends Alt<F>>(this: FluentHKT<F, I, A>, f: () => HKT<F, A>): FluentHKT<F, I, A> {
    return new FluentHKT<F, I, A>(this.I, this.I.alt(this.value, f))
  }
