...
- the `#fp-ts` channel on [FP slack](https://functionalprogramming.slack.com). Use the [FP Slack Invite bot](https://fpchat-invite.herokuapp.com/) to make an account here.
