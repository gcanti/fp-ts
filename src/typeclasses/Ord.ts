 ...
 *
 * @example
 * import { tuple } from 'fp-ts/typeclasses/Ord'
...
/**
 * @example
 * import { reverse } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
...
export const contramap: <B, A>(f: (b: B) => A) => (fa: Ord<A>) => Ord<B> = (f) => (fa) =>
  fromCompare((that) => (self) => fa.compare(f(that))(f(self)))
 ...
 * @example
 * import { sort } from 'fp-ts/ReadonlyArray'
 * import { contramap, reverse, getMonoid } from 'fp-ts/typeclasses/Ord'
 * import { pipe } from 'fp-ts/Function'
 * import { combineAll } from 'fp-ts/typeclasses/Monoid'
 * import * as B from 'fp-ts/boolean'
 * import * as N from 'fp-ts/number'
 * import * as S from 'fp-ts/string'
 *
...
export const equals =
  ...
  (that: A) =>
  (self: A) =>
    self === that || O.compare(that)(self) === 0

/**
 * Test whether one value is _strictly less than_ another.
 *
 * @example
 * import { lt } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
...
export const lt =
  ...
  (that: A) =>
  (self: A): boolean =>
    O.compare(that)(self) === -1

/**
 * Test whether one value is _strictly greater than_ another.
 *
 * @example
 * import { gt } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
 ...
 *
 * @example
 * import { leq } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
 ...
 *
 * @example
 * import { geq } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
 ...
 *
 * @example
 * import { min } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
...
export const min =
  ...
  (that: A) =>
  (self: A): A =>
    self === that || O.compare(that)(self) < 1 ? self : that

/**
 * Take the maximum of two values. If they are considered equal, the first argument is chosen.
 *
 * @example
 * import { max } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
 ...
 *
 * @example
 * import { clamp } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
 ...
 *
 * @example
 * import { between } from 'fp-ts/typeclasses/Ord'
 * import * as N from 'fp-ts/number'
 * import { pipe } from 'fp-ts/Function'
 *
