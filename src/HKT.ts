...
export interface URI2HKT4<V, U, L, A> {}
...
export type URIS3 = (URI2HKT3<any, any, any> & { never: HKT<never, never> })[
  ...
  | 'never']['_URI']
export type URIS4 = (URI2HKT3<any, any, any, any> & { never: HKT<never, never> })[
  | keyof URI2HKT3<any, any, any, any>
  | 'never']['_URI']
...
export type Type4<URI extends URIS4, V, U, L, A> = {} & URI2HKT3<V, U, L, A>[URI]
