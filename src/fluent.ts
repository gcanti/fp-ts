...
export interface Fluent3<U, L, A, F extends URIS3, I> {
  ...
  readonly ap: <A, B>(
    this: { I: Apply3<F>; value: Type3<F, U, L, (a: A) => B> },
    fa: Type3<F, U, L, A>
  ) => Fluent3<U, L, B, F, I>
...
export interface Fluent2<L, A, F extends URIS2, I> {
  ...
  readonly ap: <A, B>(
    this: { I: Apply2<F> | Apply2C<F, L>; value: Type2<F, L, (a: A) => B> },
    fa: Type2<F, L, A>
  ) => Fluent2<L, B, F, I>
...
export interface Fluent1<A, F extends URIS, I> {
  ...
  readonly ap: <A, B>(this: { I: Apply1<F>; value: Type<F, (a: A) => B> }, fa: Type<F, A>) => Fluent1<B, F, I>
...
export interface Fluent<A, F, I> {
  ...
  readonly ap: <A, B>(this: { I: Apply<F>; value: HKT<F, (a: A) => B> }, fa: HKT<F, A>) => Fluent<F, I, B>
...
class Wrapper<A, F, I> {
  ...
  ap<I extends Apply<F>, A, B>(this: { I: I; value: HKT<F, (a: A) => B> }, fa: HKT<F, A>): Wrapper<B, F, I> {
    return new Wrapper<B, F, I>(this.I, this.I.ap(this.value, fa))
  }
