...
export function fromPredicate<F extends URIS4>(
  ...
  <A, B extends A>(refinement: Refinement<A, B>): <S, R>(a: A) => Kind4<F, S, R, Exclude<A, B>, B>
...
export function fromPredicate<F extends URIS3>(
  ...
  <A, B extends A>(refinement: Refinement<A, B>): <R>(a: A) => Kind3<F, R, Exclude<A, B>, B>
...
export function fromPredicate<F extends URIS2>(
  ...
  <A, B extends A>(refinement: Refinement<A, B>): (a: A) => Kind2<F, Exclude<A, B>, B>
...
export function fromPredicate<F>(
  ...
  <A, B extends A>(refinement: Refinement<A, B>): (a: A) => HKT2<F, Exclude<A, B>, B>
...
export function fromPredicate<F>(
  ...
  return <A>(predicate: Predicate<A>) => (a: A) => F.fromEither(predicate(a) ? _.right(a) : _.left(a as never))
}
...
export function filterOrElse<M extends URIS4>(
  F: FromEither4<M>,
  M: Chain4<M>
): <A, P extends Predicate<A>, E>(
  refinement: P,
  onFalse: (a: P extends (a: any) => a is infer B ? Exclude<A, B> : A) => E
) => <S, R>(ma: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, P extends (a: any) => a is infer B ? B : A>
export function filterOrElse<M extends URIS3>(
  ...
  refinement: P,
  onFalse: (a: P extends (a: any) => a is infer B ? Exclude<A, B> : A) => E
) => <R>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, P extends (a: any) => a is infer B ? B : A>
...
export function filterOrElse<M extends URIS2>(
  ...
  refinement: P,
  onFalse: (a: P extends (a: any) => a is infer B ? Exclude<A, B> : A) => E
) => (ma: Kind2<M, E, A>) => Kind2<M, E, P extends (a: any) => a is infer B ? B : A>
...
export function filterOrElse<M>(
  ...
  refinement: P,
  onFalse: (a: P extends (a: any) => a is infer B ? Exclude<A, B> : A) => E
) => (ma: HKT2<M, E, A>) => HKT2<M, E, P extends (a: any) => a is infer B ? B : A>
export function filterOrElse<M extends URIS2>(
  F: FromEither2<M>,
  M: Chain2<M>
): <A, P extends Predicate<A>, E>(
  refinement: P,
  onFalse: (a: never) => E
) => (ma: Kind2<M, E, A>) => Kind2<M, E, never> {
  return <A, P extends Predicate<A>, E>(predicate: P, onFalse: (a: never) => E) => (ma: Kind2<M, E, A>) =>
    pipe(
      ma,
      M.chain((a) => F.fromEither(predicate(a) ? _.right(a) : _.left(onFalse(a as never))))
    ) as Kind2<M, E, never>
}
