...
) => ReaderTaskEither<R, E2 | E1, B> = /*#__PURE__*/ FromEitherModule.filterOrElse(FromEither, Chain)
...
) => ReaderTaskEither<R, E2 | E1, B> = /*#__PURE__*/ FromEitherModule.refineOrElse(FromEither, Chain)
