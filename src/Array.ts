...
export interface Combine3C<F extends URIS3, U, L> {
...
export interface Combine2<F extends URIS2> {
  ...
  <L, A>(...list: Type2<F, L, A>[]): Type2<F, L, A[]>
}
export interface Combine2C<F extends URIS2, L> {
  ...
  <A, B, C, D, E>(a: Type2<F, L, A>, b: Type2<F, L, B>, c: Type2<F, L, C>, d: Type2<F, L, D>, e: Type2<F, L, E>): Type2<
    ...
    [A, B, C, D, E]
  >
  <A>(...list: Type2<F, L, A>[]): Type2<F, L, A[]>
}
export interface Combine1<F extends URIS> {
  ...
  <A>(...list: Type<F, A>[]): Type<F, A[]>
}
export interface Combine<F> {
  <A>(a: HKT<F, A>): HKT<F, [A]>
