 ...
 * @since 3.0.0
 */
export function right<F extends HKT>(F: Pointed<F>): <A, S, R, FE, E = never>(a: A) => Kind<F, S, R, FE, These<E, A>> {
 ...
 * @since 3.0.0
 */
export function left<F extends HKT>(F: Pointed<F>): <E, S, R, FE, A = never>(e: E) => Kind<F, S, R, FE, These<E, A>> {
 ...
 * @since 3.0.0
 */
export function both<F extends HKT>(F: Pointed<F>): <E, A, S, R, FE>(e: E, a: A) => Kind<F, S, R, FE, These<E, A>> {
