...
import { identity, Lazy, pipe, Predicate, Refinement, SK } from './function'
 ...
 * @internal
 */
export const appendW = <B>(end: B) => <A>(init: ReadonlyArray<A>): ReadonlyNonEmptyArray<A | B> => [...init, end] as any
