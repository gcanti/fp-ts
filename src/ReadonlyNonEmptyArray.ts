 ...
 * @since 3.0.0
 */
export const succeed: <A>(a: A) => ReadonlyNonEmptyArray<A> = _.singleton
 ...
 * @since 3.0.0
 */
export const KleisliComposable: kleisliComposable.KleisliComposable<ReadonlyNonEmptyArrayTypeLambda> = {
  composeKleisli
}
 ...
 * @since 3.0.0
 */
export const idKleisli: <A>() => (a: A) => ReadonlyNonEmptyArray<A> = /*#__PURE__*/ fromIdentity.idKleisli(FromIdentity)

/**
 * @category instances
 * @since 3.0.0
 */
export const CategoryKind: kleisliCategory.KleisliCategory<ReadonlyNonEmptyArrayTypeLambda> = {
  composeKleisli,
  idKleisli
}
