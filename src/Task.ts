 ...
 * @since 3.0.0
 */
export const sequenceReadonlyNonEmptyArray: <A>(as: ReadonlyNonEmptyArray<Task<A>>) => Task<ReadonlyNonEmptyArray<A>> =
  /*#__PURE__*/
 ...
 * @since 3.0.0
 */
export const sequenceReadonlyNonEmptyArraySeq: <A>(
