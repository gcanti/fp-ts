 ...
 * @since 3.0.0
 */
export const toIterableComposition = <F extends TypeLambda, G extends TypeLambda>(
 ...
 * @since 3.0.0
 */
export const reduce = <F extends TypeLambda>(Foldable: Foldable<F>) =>
  <B, A>(b: B, f: (b: B, a: A) => B) => {
 ...
 * @since 3.0.0
 */
export const reduceRight = <F extends TypeLambda>(Foldable: Foldable<F>) =>
  <B, A>(b: B, f: (a: A, b: B) => B) => {
