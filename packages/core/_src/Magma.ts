 ...
 *
 * @example
 * import { reverse, combineAll } from '@fp-ts/core/Magma'
 ...
 * @since 3.0.0
 */
export const filterFirst = <S>(predicate: Predicate<S>) =>
 ...
 * @since 3.0.0
 */
export const filterSecond = <S>(predicate: Predicate<S>) =>
  (Magma: Magma<S>): Magma<S> => ({
 ...
 * @since 3.0.0
 */
export const endo = <S>(f: Endomorphism<S>) =>
  (Magma: Magma<S>): Magma<S> => ({
 ...
 *
 * @example
 * import { combineAll } from '@fp-ts/core/Magma'
 * import * as N from '@fp-ts/core/number'
 *
 ...
 * @since 3.0.0
 */
export const combineAll = <S>(Magma: Magma<S>) =>
  (startWith: S) =>
