 ...
 * @since 3.0.0
 */
export const toEntriesComposition = <F extends TypeLambda, I, G extends TypeLambda, J>(
 ...
 * @since 3.0.0
 */
export const reduceWithIndex = <F extends TypeLambda, I>(FoldableWithIndex: FoldableWithIndex<F, I>) =>
 ...
 * @since 3.0.0
 */
export const foldMapWithIndex = <F extends TypeLambda, I>(FoldableWithIndex: FoldableWithIndex<F, I>) =>
  <M>(Monoid: Monoid<M>) => {
 ...
 * @since 3.0.0
 */
export const reduceRightWithIndex = <F extends TypeLambda, I>(FoldableWithIndex: FoldableWithIndex<F, I>) =>
