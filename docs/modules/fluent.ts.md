...
export interface Fluent<F, I, A> {
  ...
  readonly apFirst: <B>(this: { I: Apply<F> }, that: HKT<F, B>) => Fluent<F, I, A>
  readonly apSecond: <B>(this: { I: Apply<F> }, that: HKT<F, B>) => Fluent<F, I, B>
  readonly chain: <B>(this: { I: Chain<F> }, f: (a: A) => HKT<F, B>) => Fluent<F, I, B>
  readonly flatten: <A>(this: { I: Chain<F>; value: HKT<F, HKT<F, A>> }) => Fluent<F, I, A>
  ...
  readonly alt: (this: { I: Alt<F> }, that: () => HKT<F, A>) => Fluent<F, I, A>
  readonly compact: <A>(this: { I: Compactable<F>; value: HKT<F, Option<A>> }) => Fluent<F, I, A>
...
export interface Fluent1<F extends URIS, I, A> {
  ...
  readonly map: <B>(this: { I: Functor1<F> }, f: (a: A) => B) => Fluent1<F, I, B>
  readonly mapWithIndex: <Ix, B>(this: { I: FunctorWithIndex1<F, Ix> }, f: (i: Ix, a: A) => B) => Fluent1<F, I, B>
  readonly ap: <B>(this: { I: Apply1<F> }, fab: Type<F, (a: A) => B>) => Fluent1<F, I, B>
  readonly apFirst: <B>(this: { I: Apply1<F> }, that: Type<F, B>) => Fluent1<F, I, A>
  readonly apSecond: <B>(this: { I: Apply1<F> }, that: Type<F, B>) => Fluent1<F, I, B>
  readonly chain: <B>(this: { I: Chain1<F> }, f: (a: A) => Type<F, B>) => Fluent1<F, I, B>
  readonly flatten: <A>(this: { I: Chain1<F>; value: Type<F, Type<F, A>> }) => Fluent1<F, I, A>
  readonly extend: <B>(this: { I: Extend1<F> }, f: (fa: Type<F, A>) => B) => Fluent1<F, I, B>
  readonly duplicate: (this: { I: Extend1<F> }) => Fluent1<F, I, Type<F, A>>
  ...
  readonly alt: (this: { I: Alt1<F> }, that: () => Type<F, A>) => Fluent1<F, I, A>
  readonly compact: <A>(this: { I: Compactable1<F>; value: Type<F, Option<A>> }) => Fluent1<F, I, A>
  ...
  readonly filterMap: <B>(this: { I: Filterable1<F> }, f: (a: A) => Option<B>) => Fluent1<F, I, B>
  readonly partition: {
...
export interface Fluent2<F extends URIS2, I, L, A> {
  ...
  readonly map: <B>(this: { I: Functor2<F> | Functor2C<F, L> }, f: (a: A) => B) => Fluent2<F, I, L, B>
  ...
  readonly mapLeft: <M>(this: { I: Bifunctor2<F> | Bifunctor2C<F, L> }, f: (l: L) => M) => Fluent2<F, I, M, A>
  readonly ap: <B>(this: { I: Apply2<F> | Apply2C<F, L> }, fab: Type2<F, L, (a: A) => B>) => Fluent2<F, I, L, B>
  readonly apFirst: <B>(this: { I: Apply2<F> | Apply2C<F, L> }, that: Type2<F, L, B>) => Fluent2<F, I, L, A>
  readonly apSecond: <B>(this: { I: Apply2<F> | Apply2C<F, L> }, that: Type2<F, L, B>) => Fluent2<F, I, L, B>
  readonly chain: <B>(this: { I: Chain2<F> | Chain2C<F, L> }, f: (a: A) => Type2<F, L, B>) => Fluent2<F, I, L, B>
  readonly flatten: <A>(this: {
    I: Chain2<F> | Chain2C<F, L>
    value: Type2<F, L, Type2<F, L, A>>
  }) => Fluent2<F, I, L, A>
  readonly extend: <B>(this: { I: Extend2<F> | Extend2C<F, L> }, f: (fa: Type2<F, L, A>) => B) => Fluent2<F, I, L, B>
  readonly duplicate: (this: { I: Extend2<F> | Extend2C<F, L> }) => Fluent2<F, I, L, Type2<F, L, A>>
  ...
  readonly alt: (this: { I: Alt2<F> | Alt2C<F, L> }, that: () => Type2<F, L, A>) => Fluent2<F, I, L, A>
  readonly compact: <A>(this: { I: Compactable2<F> | Compactable2C<F, L>; value: Option<A> }) => Fluent2<F, I, L, A>
  readonly separate: <A, B>(this: {
  ...
  readonly promap: <H, B>(this: { I: Profunctor2<F> }, f: (h: H) => L, g: (a: A) => B) => Fluent2<F, I, H, B>
  readonly compose: <B>(this: { I: Semigroupoid2<F> }, that: Type2<F, A, B>) => Fluent2<F, I, L, B>
}
```
...
export interface Fluent3<F extends URIS3, I, U, L, A> {
  ...
  readonly map: <B>(this: { I: Functor3<F> }, f: (a: A) => B) => Fluent3<F, I, U, L, B>
  readonly mapWithIndex: <Ix, B>(this: { I: FunctorWithIndex3<F, Ix> }, f: (i: Ix, a: A) => B) => Fluent3<F, I, U, L, B>
  readonly bimap: <M, B>(this: { I: Bifunctor3<F> }, f: (l: L) => M, g: (a: A) => B) => Fluent3<F, I, U, M, B>
  readonly mapLeft: <M>(this: { I: Bifunctor3<F> }, f: (l: L) => M) => Fluent3<F, I, U, M, A>
  readonly ap: <B>(this: { I: Apply3<F> }, fab: Type3<F, U, L, (a: A) => B>) => Fluent3<F, I, U, L, B>
  readonly apFirst: <B>(this: { I: Apply3<F> }, that: Type3<F, U, L, B>) => Fluent3<F, I, U, L, A>
  readonly apSecond: <B>(this: { I: Apply3<F> }, that: Type3<F, U, L, B>) => Fluent3<F, I, U, L, B>
  readonly chain: <B>(this: { I: Chain3<F> }, f: (a: A) => Type3<F, U, L, B>) => Fluent3<F, I, U, L, B>
  readonly flatten: <A>(this: { I: Chain3<F>; value: Type3<F, U, L, Type3<F, U, L, A>> }) => Fluent3<F, I, U, L, A>
  readonly extend: <B>(this: { I: Extend3<F> }, f: (fa: Type3<F, U, L, A>) => B) => Fluent3<F, I, U, L, B>
  readonly duplicate: (this: { I: Extend3<F> }) => Fluent3<F, I, U, L, Type3<F, U, L, A>>
  ...
  readonly alt: (this: { I: Alt3<F> }, that: () => Type3<F, U, L, A>) => Fluent3<F, I, U, L, A>
  readonly compact: <A>(this: { I: Compactable3<F>; value: Option<A> }) => Fluent3<F, I, U, L, A>
  readonly separate: <A, B>(this: {
    I: Compactable3<F>
    value: Either<A, B>
  ...
  readonly filterMap: <B>(this: { I: Filterable3<F> }, f: (a: A) => Option<B>) => Fluent3<F, I, U, L, B>
  readonly partition: {
  ...
  readonly promap: <H, B>(this: { I: Profunctor3<F> }, f: (h: H) => L, g: (a: A) => B) => Fluent3<F, I, U, H, B>
  readonly compose: <B>(this: { I: Semigroupoid3<F> }, that: Type3<F, U, A, B>) => Fluent3<F, I, U, L, B>
}
```
