...
```ts
import { max } from 'fp-ts/typeclasses/Monoid'
...
```ts
import { min } from 'fp-ts/typeclasses/Monoid'
import * as N from 'fp-ts/number'
import { pipe } from 'fp-ts/Function'
...
```ts
import { reverse } from 'fp-ts/typeclasses/Monoid'
...
```ts
import { struct } from 'fp-ts/typeclasses/Monoid'
import * as N from 'fp-ts/number'
import { pipe } from 'fp-ts/Function'
...
```ts
import { tuple } from 'fp-ts/typeclasses/Monoid'
import { pipe } from 'fp-ts/Function'
