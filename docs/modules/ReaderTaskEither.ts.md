...
```ts
export declare const fromSyncEither: <E, A>(fa: SyncResult<E, A>) => ReaderTaskEither<unknown, E, A>
```
...
```ts
export declare const FromIdentity: fromIdentity.FromIdentity<ReaderTaskEitherTypeLambda>
```
