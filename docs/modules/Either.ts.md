...
this function have the same behavior of `A.sequence(E.either)` but it's optimized and performs better
...
this function have the same behavior of `A.traverse(E.either)` but it's optimized and performs better
