...
pipe(_.empty() as ReadonlyMap<'a1' | 'a2', string | number>, _.filterWithIndex(isStringWithKey))
...
pipe(_.empty() as ReadonlyMap<'a1' | 'a2', string | number>, _.partitionWithIndex(isStringWithKey))
