...
const sequenceSf1 = _.sequenceS(E.Applicative)
...
const sequenceSf2 = _.sequenceS(RTE.ApplicativePar)
...
const sequenceTf1 = _.sequenceT(E.Applicative)
...
const sequenceTf2 = _.sequenceT(RTE.ApplicativePar)
