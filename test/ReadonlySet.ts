...
describe('ReadonlySet', () => {
  ...
  it('partitionMap', () => {
    deepStrictEqual(_.partitionMap(N.Eq, S.Eq)((n: number) => fail(n))(new Set([])), [new Set([]), new Set([])])
    deepStrictEqual(
  ...
  it('separate', () => {
    deepStrictEqual(_.separate(S.Eq, N.Eq)(new Set([succeed(1), fail('a'), succeed(2)])), [
      new Set(['a']),
      new Set([1, 2])
    ])
