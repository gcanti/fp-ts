...
describe('AsyncThese', () => {
  ...
  it('map', async () => {
    U.deepStrictEqual(await pipe(_.of(1), _.map(U.double))(), TH.of(2))
  })
  ...
  it('mapBoth', async () => {
    ...
    U.deepStrictEqual(await pipe(_.of(1), f)(), TH.of(2))
  ...
  it('mapError', async () => {
    ...
    U.deepStrictEqual(await pipe(_.of(1), f)(), TH.of(1))
    U.deepStrictEqual(await pipe(_.fail('a'), f)(), TH.fail('aa'))
  ...
  it('getApplicative', async () => {
    ...
    U.deepStrictEqual(await pipe(_.of(f), A.ap(_.of(1)))(), TH.of(2))
  })
  ...
  describe('getMonad', () => {
    ...
    it('map', async () => {
      const f = (n: number): number => n * 2
      U.deepStrictEqual(await pipe(_.of(1), M.map(f))(), TH.of(2))
      U.deepStrictEqual(await pipe(_.fail('a'), M.map(f))(), TH.fail('a'))
      U.deepStrictEqual(await pipe(_.both('a', 1), M.map(f))(), TH.both('a', 2))
    })

    it('flatMap', async () => {
      const f = (n: number) => (n > 2 ? _.both(`c`, n * 3) : n > 1 ? _.of(n * 2) : _.fail(`b`))
      U.deepStrictEqual(await pipe(_.of(1), M.flatMap(f))(), TH.fail('b'))
      U.deepStrictEqual(await pipe(_.of(2), M.flatMap(f))(), TH.of(4))
  ...
  it('right', async () => {
    const x = await _.of(1)()
    U.deepStrictEqual(x, TH.of(1))
  })
  ...
  it('fromResult', async () => {
    U.deepStrictEqual(await _.fromResult(E.of('a'))(), E.of('a'))
  ...
  it('match', async () => {
    ...
    U.deepStrictEqual(await pipe(_.of(1), match)(), 'right 1')
  ...
  it('matchAsync', async () => {
    ...
    U.deepStrictEqual(await pipe(_.of(1), matchAsync)(), 'right 1')
  ...
  it('swap', async () => {
    U.deepStrictEqual(await _.swap(_.of(1))(), TH.fail(1))
    U.deepStrictEqual(await _.swap(_.fail('a'))(), TH.of('a'))
  ...
  it('sequenceReadonlyArrayPar', async () => {
    ...
    U.deepStrictEqual(await pipe([right(1), right(2)], f)(), E.of([1, 2]))
